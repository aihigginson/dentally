/****** Object:  View [Audit].[v_24Hr_Processes]    Script Date: 20/04/2026 10:15:06 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

DROP VIEW IF EXISTS [Audit].[v_24Hr_Processes]
GO
CREATE   VIEW [Audit].[v_24Hr_Processes] AS
SELECT  
      l.[Run_UUID]
    , l.[Process_Name]
    , l.[Process_Type]
...
WHERE l.[Start_Time] > DATEADD(day, -1, SYSDATETIME());
GO

...
INSERT INTO [Test].[Metric_Definition]
    ([Metric_Name], [Metric_Group], [Layer], [Value_Type], [SQL_Text], [Description], [Is_Active])
VALUES
 ('GOLD_PATIENTS_WITH_DISCOUNT_T11','KPI Value','Gold','count','SELECT COUNT(DISTINCT fk_Patient) FROM Gold.Fact_Invoice_Items WHERE Tenant_ID = 11 AND Is_Discount = 1','Distinct patients with a discounted invoice',1)
...
,('GOLD_PATIENTS_WITH_DEPOSIT_T11','KPI Value','Gold','count','SELECT COUNT(DISTINCT fk_Patient) FROM Gold.Fact_Payments WHERE Tenant_ID = 11 AND Is_Deposit = 1','Distinct patients who left a deposit',1)

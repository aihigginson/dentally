...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO Gold.Dim_Treatments (
            pk_Treatment,
            Tenant_ID,
            Treatment_ID, Treatment_Code, Nomenclature, Region, UDA_Band, NHS_Treatment_Cat,
        ...
        SELECT
            ...
            src.Tenant_ID,
            src.Treatment_ID, src.Treatment_Code, src.Nomenclature, src.Region, src.UDA_Band, src.NHS_Treatment_Cat,

...
--    *08     15/06/2026  AIH Trim to Booking + Appointment_Reason only (the static columns). Delay /
--                            Next_Appointment / Current_State moved to DAX (computed from the
--                            appointment self-relationship + Recalls, with an Include/Exclude
--                            hygiene toggle). Removed the nxt / seen_again / active_bkg / latest_recall
--                            apply blocks -- lightens this load considerably.

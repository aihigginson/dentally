...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO Bronze.Practitioners (Tenant_ID, Practitioner_ID, User_ID, User_First_Name, User_Last_Name, User_Role, Practitioner_Site_ID, DW_Loaded_At)
        SELECT src.Tenant_ID, src.Practitioner_ID, src.User_ID, src.User_First_Name, src.User_Last_Name, src.User_Role, src.Practitioner_Site_ID, SYSUTCDATETIME()
        FROM #src AS src

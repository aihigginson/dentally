...
CREATE TABLE [Gold].[Fact_Recalls](
	...
	[Retention_Outlook_In_Scope] [int]      NULL,  -- 1 if first reminder sent OR due in [-24m, +1m]
	[Retention_Outlook_Booked]   [int]      NULL,  -- 1 if booked via recall or has future appointment

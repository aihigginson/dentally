...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO Bronze.Recalls (Tenant_ID, ID, Patient_ID, Practitioner_ID, Site_ID, Recall_Date, Recall_Type, Interval_Months, Status, Notes, Created_At, Updated_At, DW_Loaded_At)
        SELECT src.Tenant_ID, src.ID, src.Patient_ID, src.Practitioner_ID, src.Site_ID, src.Recall_Date, src.Recall_Type, src.Interval_Months, src.Status, src.Notes, src.Created_At, src.Updated_At, SYSUTCDATETIME()
        FROM #src AS src

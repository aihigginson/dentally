/****** Object:  View [Audit].[v_Daily_Processes]    Script Date: 20/04/2026 10:15:06 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

DROP VIEW IF EXISTS [Audit].[v_Daily_Processes]
GO
CREATE   VIEW [Audit].[v_Daily_Processes] AS
SELECT  
      l.[Run_UUID]
    , l.[Process_Name]
    , l.[Process_Type]
    , l.[Start_Time]
    , COALESCE(t.[End_Time], t.[End_Time], l.[End_Time]) AS [End_Time]
...
WHERE l.[Start_Time] > DATETRUNC(day, SYSDATETIME());
GO

...
-- Patients
    ...
    ('lapsed_patients',            'Lapsed Patients',                    'patients',   'count',    'Patients whose 24-month exam clock expired in the period',                1, 0, 1, 26, 'below', 'point_in_time',
        'The number of patients whose 24-month examination clock expired during the period — who passed the point of being considered active without returning. Lower is better; a measure of attrition.'),
